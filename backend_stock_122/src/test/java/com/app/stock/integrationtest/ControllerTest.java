package com.app.stock.integrationtest;
...
import com.app.stock.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("stock", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/stock/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/stock/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM stock_098.PetService");
    jdbcTemplate.execute("DELETE FROM stock_098.PetOwner");
    jdbcTemplate.execute("DELETE FROM stock_098.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM stock_098.Manager");
    jdbcTemplate.execute("DELETE FROM stock_098.Document");
    jdbcTemplate.execute("DELETE FROM stock_098.Pet");
     jdbcTemplate.execute("DELETE FROM stock_098.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM stock_098.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM stock_098.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM stock_098.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM stock_098.PetCareCenterPets");
